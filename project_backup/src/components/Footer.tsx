      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="border-t border-primary-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <a href="#" className="text-slate-400 hover:text-secondary-400 transition-colors text-sm">Privacy Policy</a>
            <a href="#" className="text-slate-400 hover:text-secondary-400 transition-colors text-sm">Terms of Service</a>
            <button 
              onClick={scrollToTop}
              className="w-10 h-10 rounded-full bg-primary-800 hover:bg-secondary-500 hover:text-primary-900 text-white transition-all flex items-center justify-center ml-4"
